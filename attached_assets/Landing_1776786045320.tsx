...
// =============================================================
// ASSET IMPORTS
// Drop these three files into your @assets folder:
//   - Logo_Light_transparent.png     (icon, nav)
//   - Full_Logo_Light_transparent.png (wordmark, footer watermark)
...
const GlobalStyles = () => (
  <style>{`
    /* Fonts loaded via <link> tag in index.html for better performance */
    ...
    * { -webkit-font-smoothing: antialiased; }
    ...
    @keyframes bx-heartbeat {
      0%, 100% { transform: scale(1); filter: drop-shadow(0 0 5px rgba(226,18,36,0.5)); }
      15%, 45% { transform: scale(1.2); filter: drop-shadow(0 0 12px rgba(226,18,36,0.9)); }
    ...
    .bx-aurora {
      background: radial-gradient(circle at 50% 50%,
        rgba(226,18,36,0.35) 0%,
        rgba(226,18,36,0.12) 40%,
        transparent 70%);
    }
    .bx-grid-bg {
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="max-w-5xl -mt-8 mx-auto h-[30rem] md:h-[40rem] w-full border-2 p-2 md:p-3 rounded-[30px] shadow-2xl bg-black"
        >
          <div
...
// =============================================================
// APP STORE BUTTONS (futuristic dark-mode)
// =============================================================
...
const GooglePlayButton = () => (
  <MagneticButton className="bx-store-btn group flex items-center gap-3 px-5 py-3 rounded-2xl font-body text-white min-w-[180px]">
    <svg className="w-7 h-7 flex-shrink-0" viewBox="0 0 512 512" aria-hidden="true">
      ...
      <path fill="url(#gplay-a)" d="M71.23 26.355c-5.763 6.1-9.17 15.576-9.17 27.847v403.601c0 12.272 3.407 21.748 9.17 27.847l1.35 1.319 226.169-226.169v-5.337L72.58 25.035z" transform="translate(0 0)" />
      <path fill="url(#gplay-b)" d="M373.064 335.949L297.749 260.6v-5.336l75.345-75.345 1.696.974 89.272 50.723c25.491 14.483 25.491 38.171 0 52.654l-89.272 50.754z" transform="translate(0 0)" />
      <path fill="url(#gplay-c)" d="M374.79 334.975l-77.041-77.041L71.23 484.453c8.402 8.903 22.283 10.004 37.926 1.131l265.634-150.609" transform="translate(0 0)" />
      <path fill="url(#gplay-d)" d="M374.79 180.893L109.156 30.315C93.513 21.412 79.632 22.544 71.23 31.447l226.519 226.487z" transform="translate(0 0)" />
    </svg>
    <div className="flex flex-col items-start leading-tight text-left">
      <span className="text-[9px] font-medium tracking-wide text-white/60 uppercase">
        Get it on
  ...
  return (
    <section className="relative min-h-screen w-full flex flex-col overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center bottom, rgba(226,18,36,0.25) 0%, transparent 70%)",
        }}
      />
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center top, rgba(226,18,36,0.15) 0%, transparent 70%)",
        }}
      />
    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
        {[
          {
            num: "01",
            headline: "Any sport. Any format.",
            body: "Basketball, football, netball, cricket — if it has a scoresheet, BoxStat runs it. Purpose-built, not rebadged.",
          },
          {
            num: "02",
            headline: "Your data stays yours.",
            body: "We don't sell it, profile it, or ad-target your members. Ever. Export everything, anytime.",
          },
          {
            num: "03",
            headline: "Mobile-first, always.",
            body: "Coaches don't coach from desks. Parents don't RSVP from laptops. Neither should their software.",
          },
        ].map((item) => (
...
const CinematicFooter = () => {
  ...
  const giantY = useTransform(scrollYProgress, [0, 1], ["-4vh", "0vh"]);
  const giantScale = useTransform(scrollYProgress, [0, 1], [1.05, 1]);
  const giantOpacity = useTransform(scrollYProgress, [0, 0.5, 1], [0, 0.9, 1]);

  const headingY = useTransform(scrollYProgress, [0.2, 0.8], [60, 0]);
  const headingOpacity = useTransform(scrollYProgress, [0.2, 0.6], [0, 1]);

  const linksY = useTransform(scrollYProgress, [0.35, 0.9], [40, 0]);
  const linksOpacity = useTransform(scrollYProgress, [0.35, 0.7], [0, 1]);
  ...
  return (
    ...
    >
      <footer
        className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden font-body"
        style={{ background: "#000", color: "#fff" }}
      >
        <div
          className="bx-aurora absolute left-1/2 top-1/2 h-[60vh] w-[80vw] -translate-x-1/2 -translate-y-1/2 rounded-[50%] blur-[80px] pointer-events-none z-0"
          style={{ animation: "bx-breathe 8s ease-in-out infinite alternate" }}
        />
        <div className="bx-grid-bg absolute inset-0 z-0 pointer-events-none" />

        <motion.div
          className="absolute left-1/2 -translate-x-1/2 z-0 pointer-events-none select-none"
          style={{
            y: giantY,
            scale: giantScale,
            ...
            top: "2vh",
            width: "110vw",
            filter: "drop-shadow(0 0 60px rgba(226,18,36,0.25))",
          }}
        >
          <img
            src={LOGO_FULL}
        ...
        {/* marquee */}
        <div
          className="absolute top-16 left-0 w-full overflow-hidden py-4 z-10 -rotate-2 scale-110 shadow-2xl"
          style={{
        ...
        <motion.div
          ...
          className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-20 w-full max-w-5xl mx-auto"
        >
...
export default function Landing() {
  return (
    <div className="relative w-full bg-black text-white overflow-x-hidden font-body selection:bg-red-500/30">
      <GlobalStyles />
      <Hero />
      <ContainerScroll
        titleComponent={
