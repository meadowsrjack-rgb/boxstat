...
export default function StorePurchaseBanner({ onNavigateToStore }: { onNavigateToStore?: () => void }) {
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0 pr-4">
          <p className="text-sm font-semibold text-red-900">
            {data.pendingCount === 1
              ? "1 store order needs dispatch!"
              : `${data.pendingCount} store orders need dispatch!`}
          </p>
