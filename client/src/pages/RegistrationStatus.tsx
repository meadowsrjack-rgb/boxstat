...
export default function RegistrationStatus() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-full bg-gray-50 safe-bottom flex items-center justify-center" data-testid="loading-registration">
  ...
  return (
    <div className="min-h-full bg-gray-50 safe-bottom p-4">
