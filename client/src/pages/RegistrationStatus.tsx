...
export default function RegistrationStatus() {
  ...
  if (isLoading) {
    return (
      <div className="flex-1 bg-gray-50 safe-bottom flex items-center justify-center" data-testid="loading-registration">
  ...
  return (
    <div className="flex-1 bg-gray-50 safe-bottom p-4">
