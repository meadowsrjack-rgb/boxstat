...
import { ArrowLeft, Settings, Users, DollarSign, Image, Calendar, Edit, Trash2, Plus, MoreHorizontal, Ticket, Copy, Check } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="pricing" className="space-y-6">
            ...
            <CouponSection programId={programId} />
          </TabsContent>
        </Tabs>
      </div>
    </div>
...
function CouponSection({ programId }: { programId: string }) {
  const { toast } = useToast();
  ...
  const isMaxed = (coupon: any) => coupon.maxUses && coupon.currentUses >= coupon.maxUses;
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Generate discount coupons for this program. Coupons expire 24 hours after creation.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {isLoading ? (
          ...
          <p className="text-sm text-gray-500 text-center py-4">No coupons created for this program yet.</p>
        ) : (
          <Table>
            <TableHeader>
              <TableRow>
                  ...
                  <TableRow key={coupon.id}>
                    ...
                    <TableCell>
                      <div className="flex gap-1">
                        <Button variant="ghost" size="sm" onClick={() => copyCode(coupon)} title="Copy code">
