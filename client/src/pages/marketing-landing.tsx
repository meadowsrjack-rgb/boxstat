...
const ContainerScroll = ({
  ...
  // Tilt flattens across the middle of the scroll range, then stays flat
...
const CinematicFooter = () => {
  ...
  // Drive fade-ins off the section's own scroll range
  ...
  const watermarkOpacity = useTransform(scrollYProgress, [0.05, 0.5], [0, 1]);
  ...
  return (
    ...
    >
      ...
      {/* diagonal marquee — near the top of the section */}
      <div
