...
const Features = () => (
  <section id="features" className="relative w-full py-24 md:py-32 px-6 md:px-12 bg-black">
...
const TrustRow = () => (
  <section id="migrate" className="relative w-full py-20 md:py-28 px-6 md:px-12 border-t border-white/5 bg-black">
