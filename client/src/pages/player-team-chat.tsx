...
export default function PlayerTeamChat() {
  ...
  if (!userTeam) {
    return (
      <div className="min-h-screen-safe bg-gradient-to-br from-green-500 to-blue-600 flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen-safe bg-gradient-to-br from-green-500 to-blue-600">
      {/* Header */}
