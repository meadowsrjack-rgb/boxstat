...
export default function TeamDetailPage() {
  ...
  if (isLoading) {
    return (
      <div className="flex-1 overflow-y-auto bg-gradient-to-br from-red-50 to-red-100 dark:from-gray-900 dark:to-gray-800 safe-bottom flex items-center justify-center">
