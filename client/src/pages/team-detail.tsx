...
export default function TeamDetailPage() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-full bg-gradient-to-br from-red-50 to-red-100 dark:from-gray-900 dark:to-gray-800 safe-bottom flex items-center justify-center">
  ...
  return (
    <div className="min-h-full bg-gradient-to-br from-red-50 to-red-100 dark:from-gray-900 dark:to-gray-800 safe-bottom">
