...
-   **Admin Team Assignment with Auto-Enrollment**: Facilitates player assignment to teams with automatic enrollment into associated programs. Admin-added and team-assigned players (no payment) receive a 60-day grace period enrollment. Migration wizard players without a `subscriptionEndDate` also get 60-day grace. The enrollment expiry banner warns parents 7 days before grace period ends and prompts them to enroll via payments.
