...
export function registerClaimRoutes(app: Express): void {
  ...
  app.post('/api/admin/generate-claim-link', requireAuth, async (req: any, res) => {
    try {
  ...
  // ========== SEARCH PLAYERS ==========
  app.get('/api/players/search', requireAuth, async (req: any, res) => {
    try {
  ...
  // ========== REQUEST CLAIM CODE ==========
  app.post('/api/players/claim/request', requireAuth, async (req: any, res) => {
    try {
  ...
  // ========== VERIFY CLAIM CODE ==========
  app.post('/api/players/claim/verify', requireAuth, async (req: any, res) => {
    try {
  ...
  app.get('/api/users/:userId/players', requireAuth, async (req: any, res) => {
    try {
  ...
  app.get('/api/admin/approvals/pending', requireAuth, async (req: any, res) => {
    try {
      // TODO: Add admin role check
  ...
  // ========== SYNC NOTION DATA ==========
  app.post('/api/sync/notion', requireAuth, async (req: any, res) => {
    try {
      // TODO: Add admin role check
