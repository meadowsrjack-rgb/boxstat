...
export const seedBadgesAndTrophies = async () => {
  ...
  try {
    console.log("  ℹ️  Using upsert to preserve existing badge/trophy references");
    ...
    console.log(`  ✓ Seeded ${trophyData.length} trophies`);

    // === BADGES ===
    
    // Hall of Fame (Gold) – Legends Only
    const hallOfFameBadges = [
      ...
      },
      {
        name: "The Paragon",
        slug: "the-paragon",
        description: "10× Student of the Game",
    ...
    // Superstar (Purple) – Elite Consistency
    const superstarBadges = [
      ...
      },
      {
        ...
        description: "5× Student of the Game",
    ...
    // All-Star (Blue) – Recognition & Milestones
    const allStarBadges = [
      {
        name: "Game Changer",
        slug: "game-changer",
      ...
      },
      {
        name: "The Protégé",
        slug: "the-protege",
        description: "3× Student of the Game",
    ...
    console.log(`  ✓ Seeded ${allBadges.length} badges (${hallOfFameBadges.length} Hall of Fame, ${superstarBadges.length} Superstar, ${allStarBadges.length} All-Star, ${starterBadges.length} Starter, ${prospectBadges.length} Prospect)`);

    console.log("✅ Badge and trophy seeding completed successfully!");
    ...
    console.error("❌ Error seeding badges and trophies:", error);
    throw error;
  }
};
