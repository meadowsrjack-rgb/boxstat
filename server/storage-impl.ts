...
class DatabaseStorage implements IStorage {
  ...
  async updateUser(id: string, updates: Partial<User>): Promise<User | undefined> {
    const dbUpdates: any = {
      ...
      previousTeams: updates.previousTeams,
      playingExperience: updates.playingExperience,
      philosophy: updates.philosophy,
      bio: updates.bio,
      specialties: updates.specialties,
      coachingLicense: updates.coachingLicense,
  ...
  async updateTeam(id: string, updates: Partial<Team>): Promise<Team | undefined> {
    ...
    const dbUpdates: any = {
      ...
      division: updates.division,
      level: updates.level,
      minAge: updates.minAge !== undefined ? (updates.minAge ?? null) : undefined,
      maxAge: updates.maxAge !== undefined ? (updates.maxAge ?? null) : undefined,
      ...
      managerIds: updates.managerIds,
      strengthCoachIds: updates.strengthCoachIds,
      color: updates.color,
  ...
  async updateEvent(id: string, updates: Partial<Event>): Promise<Event | undefined> {
    ...
    const dbUpdates: any = {
      ...
      location: updates.location,
      meetingLink: (updates as any).meetingLink,
  ...
  async createProgram(program: InsertProgram): Promise<Program> {
    ...
    const dbProgram = {
      ...
      billingIntervalDays: program.billingIntervalDays,
      price: program.price,
  ...
  async getEnrollmentsByAccountHolder(accountHolderId: string): Promise<ProductEnrollment[]> {
    const results = await db.select().from(schema.productEnrollments)
  ...
  private mapDbUserToUser(dbUser: any): User {
    return {
      ...
      previousTeams: dbUser.previousTeams,
      playingExperience: dbUser.playingExperience,
      philosophy: dbUser.philosophy,
      bio: dbUser.bio,
      specialties: dbUser.specialties || [],
      coachingLicense: dbUser.coachingLicense,
      ageGroups: dbUser.ageGroups || [],
  ...
  private mapDbTeamToTeam(dbTeam: any): Team {
    return {
      ...
      level: dbTeam.level,
      minAge: dbTeam.minAge ?? null,
      maxAge: dbTeam.maxAge ?? null,
      coachId: dbTeam.coachId,
      headCoachIds: dbTeam.headCoachIds || [],
      assistantCoachIds: dbTeam.assistantCoachIds || [],
      managerIds: dbTeam.managerIds || [],
      strengthCoachIds: dbTeam.strengthCoachIds || [],
      color: dbTeam.color || undefined,
  ...
  private mapDbEventToEvent(dbEvent: any): Event {
    return {
      ...
      meetingLink: dbEvent.meetingLink ?? undefined,
  ...
  private mapDbProgramToProgram(dbProgram: any): Program {
    return {
      ...
      billingIntervalDays: dbProgram.billingIntervalDays,
      ...
      trialPeriodDays: dbProgram.trialPeriodDays,
